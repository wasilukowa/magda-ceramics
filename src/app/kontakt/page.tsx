export const metadata = { title: "Contact — Magda Ceramics" };
    ...
    <div className="max-w-xl mx-auto px-6 py-20">
      ...
      <form className="flex flex-col gap-6">
        <div className="flex flex-col gap-2">
          <label className="text-xs tracking-widest uppercase text-[var(--muted)]">Name</label>
          <input
            type="text"
        ...
        <div className="flex flex-col gap-2">
          <label className="text-xs tracking-widest uppercase text-[var(--muted)]">Message</label>
          <textarea
            rows={6}
