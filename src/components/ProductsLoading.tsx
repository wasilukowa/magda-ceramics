// Siatka-zaślepka. Wydzielona, bo czeka na nią także granica <Suspense> wokół
// listingu: nagłówek i rząd kategorii są już wtedy narysowane, brakuje samych
// produktów i paska sortowania.
export function ProductGridSkeleton() {
  return (
    <div className="animate-pulse" aria-hidden="true">
      <div className="h-9 w-full max-w-sm bg-[var(--color-ceramic)] mb-8 ml-auto" />
